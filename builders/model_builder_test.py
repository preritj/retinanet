...
from object_detection.models import ssd_nas_fpn_feature_extractor as ssd_nas_fpn
...
class ModelBuilderTest(tf.test.TestCase):
    ...
    def test_create_ssd_nas_mobile_fpn_model_from_config(self):
        model_text_proto = """
      ssd {
        feature_extractor {
        ...
        self.assertIsInstance(model, ssd_meta_arch.SSDMetaArch)
        self.assertIsInstance(model._feature_extractor,
                              ssd_nas_fpn.SSDNasMobileFpnFeatureExtractor)
